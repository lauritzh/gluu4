...
1. [Download the plugin](https://maven.gluu.org/maven/org/gluu/casa/plugins/custom-branding/4.3.1.Final/custom-branding-4.3.1.Final-jar-with-dependencies.jar)
